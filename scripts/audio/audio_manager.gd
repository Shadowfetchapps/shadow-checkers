...
const ALIASES := {"ui": "ui_click", "win": "victory", "move": "place", "king": "crown", "multi": "multi_capture"}
...
func _ready() -> void:
	...
	add_child(_music)
	var track := AUDIO_DIR + "music_club.ogg"
...
func _fallback(cue: String) -> AudioStreamWAV:
	match cue:
		"place", "select", "slide":
			return _knock(420.0, 0.09)
		"capture":
			return _knock(260.0, 0.16)
		"multi_capture":
			return _knock(300.0, 0.2)
		"hint", "clock_warning":
