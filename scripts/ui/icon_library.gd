...
const PATHS := {
	...
	"crown": ["M4 18h16", "M4.5 18 3 8l5 4 4-7 4 7 5-4-1.5 10z"],
	"disc": ["M12 5.5c4.7 0 8.5 1.8 8.5 4v4c0 2.2-3.8 4-8.5 4s-8.5-1.8-8.5-4v-4c0-2.2 3.8-4 8.5-4z", "M3.5 9.5c0 2.2 3.8 4 8.5 4s8.5-1.8 8.5-4"],
