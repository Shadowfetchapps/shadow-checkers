...
const APP_ID := "shadow-checkers"
const SCHEMA := 3

const QUALITIES := ["low", "medium", "high", "ultra"]
const BOARD_THEMES := ["club", "classic", "slate", "marble"]
const PIECE_STYLES := ["club", "classic", "ivory", "stone"]
...
var board_theme: String = "club"
var piece_style: String = "club"
...
var show_square_numbers: bool = false
var show_movable: bool = true
...
func to_dict() -> Dictionary:
	return {
		...
		"show_square_numbers": show_square_numbers,
		"show_movable": show_movable,
		"variant": variant,
...
func from_dict(d: Dictionary) -> void:
	...
	auto_complete = bool(d.get("auto_complete", auto_complete))
	show_square_numbers = bool(d.get("show_square_numbers", show_square_numbers))
	show_movable = bool(d.get("show_movable", show_movable))
	variant = _pick(d.get("variant", variant), VARIANTS, variant)
...
## 1.x stored `fullscreen`, `sound_volume`, `ai_difficulty`, `clock_seconds`.
